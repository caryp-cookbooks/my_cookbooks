...
attribute "rightimage/image_upload_bucket",
  ...
  :required => "required",
  :recipes => [ "rightimage::do_euca" ,"rightimage::do_ec2" , "rightimage::do_centos" , "rightimage::do_ubuntu" , "rightimage::default" ]
...
attribute "rightimage/image_name_override",
  ...
  :required => "optional",
  :recipes => [ "rightimage::do_euca" ,"rightimage::do_ec2", "rightimage::default" ]
