...
* The Opscode's public cookbooks must be in your cookbook path -- mysql cookbook used for client install.
...
Boot Scripts
  * default - performs base server install and configuration. && updates the crontab for DB Backups using EBS-style calls.
